<template>
  <section class="flex justify-around">
    <figure v-for="book in books" v-show="onFilter(book.title)" :key="book.id">
      ...
      <img v-if="book.thumbnail" :alt="$t('book.cover-image-alt', [book.title])" :src="book.thumbnail" />
      <img v-else alt="{{ $t('book.cover-image-alt', [book.title]) }}" src="@/assets/no_cover.jpg" />
