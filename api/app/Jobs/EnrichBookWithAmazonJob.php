...
class EnrichBookWithAmazonJob implements ShouldQueue
{
    ...
    private function updateBookWithAmazonData(array $amazonData): void
    {
        ...
        if (isset($amazonData['amazon_asin']) && !empty($amazonData['amazon_asin'])) {
            ...
            if (!empty($amazonData['height'])) $updateData['height'] = $amazonData['height'];
            if (!empty($amazonData['width'])) $updateData['width'] = $amazonData['width'];
            if (!empty($amazonData['thickness'])) $updateData['thickness'] = $amazonData['thickness'];
