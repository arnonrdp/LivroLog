<template>
  <div class="loader">
    <svg class="book-wrapper" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      x="0px" y="0px" viewBox="0 0 260 260" style="enable-background: new 0 0 260 260" xml:space="preserve">
      <g>
        <path class="book-inner" d="M134.7,191.2c-0.4-0.1-0.8-0.1-1.2-0.1s-0.8,0-1.2,0.1L49,202.3V70.7l83.3,11.1c0.4,0.1,0.8,0.1,1.2,0.1 
        s0.8,0,1.2-0.1L218,70.7v131.6L134.7,191.2z" />
        <path class="book-border" d="M54,76.4l77.7,10.3c0.6,0.1,1.2,0.1,1.8,0.1s1.2,0,1.8-0.1L213,76.4v120.2l-77.7-10.3
    ...
    <!-- page svg -->
    <svg class="page-wrapper" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      x="0px" y="0px" viewBox="0 0 260 260" style="enable-background: new 0 0 260 260" xml:space="preserve">
      <g>
        <polygon class="page-inner" points="138,191.6 138,81.4 218,70.7 218,202.3 	" />
        <g>
          <path class="page-border" d="M213,76.4v120.2l-70-9.3V85.7L213,76.4 M219,65.6c-0.2,0-0.4,0-0.5,0L134,76.8c-0.2,0-0.4,0-0.5,0
